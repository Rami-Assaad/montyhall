...
#'
#' @details
#' The game setup replicates the game on TV show "Let's Make a Deal"
#' where there are three doors a contestant to choose from, one of
#' which has a car behind it and two have a goats. The contestant
#' selects a door then the host have goats. The contestant selects
#' a door, then the host opens a door to reveal a goat, and then
#' the contestant is given a opportunity to stay with their with
#' their original selection or switch to other unopened door. There
#' was a famous debate about whether it was optimal to stay or
